...
public class CalendarToExcel {
    ...
    public  static  void GenerateExcel(String RutaFile, Calendar calendar, String JSONContenidos, Medico AdministratorUser) throws IOException
	{
                    ...
                    if(cnt > currentDayOfWeek && calendar.get(Calendar.MONTH) == month) {
                        ...
                        for (int d=0;d<lGuardias.length;d++)
                        {
                            ...
                            //    Cell dayCell_2_GUARDIAS = rowGuardias.createCell(i*2 + 1);
                        		...
                        		List<Medico> _lMedico = MedicoDBImpl.getMedicos(oGuardias.getIdMedico(), AdministratorUser.getServicioId());
